      ...
      <header className="bg-white shadow flex justify-between items-center">
        ...
        <div className="pr-6">
          <button
            ...
            className="bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-4 rounded shadow transition duration-200"
          >
            Logout
          </button>
        </div>
        ...
        {profile ? (
          <div className="bg-white shadow rounded-lg p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-gray-700">
                <span className="font-semibold">Blood Group:</span> {profile.blood_group}
              </p>
            </div>
            <div>
              <p className="text-gray-700">
                <span className="font-semibold">Height:</span> {profile.height_cm} cm
              </p>
              <p className="text-gray-700">
                <span className="font-semibold">Weight:</span> {profile.weight_kg} kg
              </p>
              <p className="text-gray-700">
                <span className="font-semibold">Address:</span> {profile.address}
              </p>
              <p className="text-gray-700">
                <span className="font-semibold">Conditions:</span> {profile.existing_conditions}
              </p>
            </div>
          </div>
        ) : (
